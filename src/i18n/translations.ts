...
export const translations: Record<AppLanguage, TranslationStrings> = {
  hi: {
    ...
    langHindiDesc: 'मुख्य भाषा • SIH समस्या कथन आधारित (प्राथमिक शिक्षकों एवं कक्षा अध्यापन हेतु विशेष रूप से अनुकूलित)',
    langHindiBadge: 'मुख्य भाषा (Primary)',
    langEnglishTitle: 'English (अंग्रेज़ी)',
    langEnglishDesc: 'द्वितीयक भाषा • संकाय (Faculty), प्रशासकों एवं द्विभाषी विद्यार्थियों हेतु अत्यंत उपयोगी',
    langEnglishBadge: 'सहायक भाषा (Secondary)',
  ...
  en: {
    ...
    langHindiTitle: 'हिन्दी (Hindi)',
    langHindiDesc: 'Primary Language • Based on SIH Problem Statement (Tailored for primary teachers and classroom instruction)',
    langHindiBadge: 'Primary Language (Recommended)',
    langEnglishTitle: 'English',
    langEnglishDesc: 'Secondary Language • Highly useful for faculty, bilingual instruction, administrators & students',
    langEnglishBadge: 'Secondary Language',
